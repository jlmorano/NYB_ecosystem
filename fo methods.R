...
# make of list of the files to be analyzed, use the GSM method only
...
# gb_mask = readShapePoly("/Users/janellemorano/Git/Reference-R-scripts/Remote sensing/shape file/gbkPoly.shp")
library(sf)
gb_mask = st_read("/Users/janellemorano/Git/Reference-R-scripts/Remote sensing/shape file/gbkPoly.shp")
